...
Descrition: Test file based on original calipso_l1p5.py 
...
class CALIPSO_L1p5(object):
   ...
   def __init__ (self,Path,keep=None,Verbose=1,only_good=True):
     """
...
#    syn_time = datetime(2008,6,30,0,0,0)
    syn_time = datetime(2019,9,2,0,0,0)
    print('test, syn_time',syn_time)
